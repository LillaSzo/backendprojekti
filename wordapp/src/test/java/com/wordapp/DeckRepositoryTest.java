...
public class DeckRepositoryTest {
    ...
    public void findByName(){
        List<Deck> decks = deckRepository.findByName("Ohjelmointi");
    ...
    public void createNewDeck(){
        ...
        Deck deck = new Deck("Testin test deck", languageRepository.findByName("Finnish").get(0), languageRepository.findByName("English").get(0), appUseRepository.findByUsername("user"));
